            ...
            <Card className="p-8 max-w-sm w-full shadow-lg rounded-lg">
                <div className="flex flex-col items-center">
                    ...
                    <div className="relative w-24 h-24 mb-4">
                        ...
                        <div className="absolute inset-0 border-4 border-blue-600 rounded-full animate-spin-slow" style={{ borderRightColor: 'transparent', borderTopColor: 'transparent' }}></div>
                    </div>
