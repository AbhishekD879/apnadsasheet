        ...
        <div className="flex items-center justify-center min-h-screen bg-[#f8f8fd]">
            <Card className="w-[350px]">
                <CardHeader className="space-y-1">
                    ...
                    <CardDescription className="text-center">Login or create an account to start your journey</CardDescription>
                </CardHeader>
                <CardContent className="grid gap-4">
                    <Tabs defaultValue="login" className="w-full">
                        ...
                        {showPassword ? "Hide password" : "Show password"}
                                ...
                                <Button onClick={handleLogin} className="w-full mt-4 bg-[#6674cc] hover:bg-[#505ba0]" type="submit" disabled={isLoading}>
                        ...
                        {showPassword ? "Hide password" : "Show password"}
                                ...
                                <Button onClick={handleRegister} className="w-full mt-4 bg-[#6674cc] hover:bg-[#505ba0]"
