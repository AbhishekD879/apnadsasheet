...
export default function Problem() {
  ...
  return (
    <main className="flex-1 flex flex-col overflow-hidden">
      {/* Header */}
      <header
        className={`p-4 flex items-center justify-between border-b border-[#e1e1e1] ${isDarkMode ? "bg-gray-800" : "bg-white"}`}
      >
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    <div className="flex flex-wrap gap-2 mt-2">
                      <Badge
                        variant="secondary"
                        className="bg-[#6674cc] text-white"
                      >
                        Easy
                      </Badge>
                      <Badge
              ...
              <Tabs defaultValue="problem">
                ...
                <TabsContent value="solution">
                  <Card>
                    ...
                    <CardContent>
                      <pre
                        className={`p-4 rounded-md overflow-x-auto ${isDarkMode ? "bg-gray-800" : "bg-[#f8f8fd]"}`}
                      >
  ...
  // Your implementation here
                  ...
                  <div className="mt-4">
                    ...
                    <pre
                      className={`p-2 rounded-md ${isDarkMode ? "bg-gray-800 text-white" : "bg-gray-100"}`}
                    >
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    Level up to Gold by solving 8 more problems!
                  </p>
                </CardContent>
              </Card>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      ...
                      <span className="text-sm">
                        Exclusive "Code Ninja" avatar at 50 problems
                      </span>
                    </li>
                    <li className="flex items-center">
                      <Star className="h-5 w-5 mr-2 text-purple-500" />
                      <span className="text-sm">
                        1-month free premium at 100 problems
                      </span>
                    </li>
                    <li className="flex items-center">
                      <Award className="h-5 w-5 mr-2 text-green-500" />
                      <span className="text-sm">
                        Certificate of Achievement at 500 problems
                      </span>
                    </li>
                  </ul>
                </CardContent>
      ...
      {/* Footer */}
      <footer
        className={`border-t border-[#e1e1e1] p-4 text-center text-sm ${isDarkMode ? "bg-gray-800 text-gray-300" : "bg-white text-gray-600"}`}
      >
