...
import { Search,Layers, GitBranch, TreesIcon as Tree, Cpu, Zap, Workflow, BarChart, CheckCircle, Circle, HelpCircle, Youtube, ExternalLink, BookOpen, Medal, Target, Award, Bookmark, Calendar, Activity, Gift } from 'lucide-react'
...
export default function TopicExplorer() {
    ...
    const saveCompletedTopics = (newCompletedTopics: Record<string, boolean>) => {
        const validatedTopics = Object.entries(newCompletedTopics).reduce((acc, [key, value]) => {
            acc[key] = value === true;
            return acc;
                                                                        ...
                                                                        <li key={problem.name}>
                                                                            <Card className="p-4 hover:bg-gray-50 transition-colors duration-200">
                                                                                <div className="flex items-center justify-between">
                                                                                    <div className="flex items-center space-x-2">
                                                                                        <Checkbox
                                                                                            checked={completedTopics[problem.name] || false}
                                                                                            onCheckedChange={(checked) => {
                                                                                                saveCompletedTopics({
                                                                                                    ...completedTopics,
                                                                                                    [problem.name]: checked === true
                                                                                                })
                                                                                            }}
                                                                                        />
                                                                                    ...
                                                                                    <div className="flex space-x-2">
                                                                                        ...
                                                                                        <Button variant="default" onClick={() => handleProblemClick(problem.name)}>
                                                                                            Solve
                                                                                        </Button>
                                                                                        <TooltipProvider>
                                                                                            <Tooltip>
                                                                                                <TooltipTrigger asChild>
                                                                                                    <Button
                                                                                                        variant="outline"
                                                                                                        size="icon"
                                                                                                        onClick={() => toggleBookmark(problem.name)}
                                                                                                    >
                                                                                                        <Bookmark
                                                                                                            className={`h-4 w-4 ${
                                                                                                                bookmarks.includes(problem.name)
                                                                                                ...
                                                                                                <TooltipContent>
                                                                                                    <p>{bookmarks.includes(problem.name) ? 'Remove Bookmark' : 'Add Bookmark'}</p>
                                                                                                </TooltipContent>
                                                                                            </Tooltip>
                                                                                        </TooltipProvider>
                                                                                    </div>
